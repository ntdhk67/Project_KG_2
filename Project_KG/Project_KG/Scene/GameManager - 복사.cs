...
{
    public class GameManager2:KGBehaviour//대충 scene1
    {
        ...
        public string clear;
        protected MemoryPool _memoryPool;
        public GameManager2(KGEngine engine) : base(engine)
        {
            _memoryPool = new MemoryPool(ThisEngine);
        }
